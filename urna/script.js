...
// criando uma for para pecorrer os numeros
    let numeroHtml = '';
    numero = '';
    votoBranco=  false;
...
// criando funções para os bottoes principais
function clicou(n){
...
function confirma(){
    ...
    if(votoConfirmado) {
        ...
        if(etapas[etapaAtual] !== undefined) {
            ...
            //criando tela de fim!
            document.querySelector('.tela').innerHTML = `<div class = "aviso_fim pisca">FIM!</div>`;     
            console.log(votos);
